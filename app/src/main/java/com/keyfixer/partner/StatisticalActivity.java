...
public class StatisticalActivity extends AppCompatActivity
    ...
    private void Initializing() {
        ...
        txtTotalTripOfDay = (TextView) findViewById(R.id.txt_Day_totalRequest);
        txtTotalFeeOfDay = (TextView) findViewById(R.id.txtTotal);
        datePickerTimeline = (DatePickerTimeline) findViewById(R.id.datePicker);
        datePickerTimeline.setFirstVisibleDate(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH));
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                lvHistory.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Toast.makeText(StatisticalActivity.this, "Đang fix", Toast.LENGTH_SHORT).show();
